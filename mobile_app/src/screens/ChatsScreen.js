          ...
          <View className="w-full bg-white dark:bg-[#1e2128] rounded-md p-6 border border-gray-200 dark:border-gray-800">
            ...
            <View className="flex-row justify-between mb-6">
              <TouchableOpacity
                ...
                className={`flex-1 p-3 rounded-md border mr-2 items-center ${!identity?.is_stealth
              ...
              <TouchableOpacity
                ...
                className={`flex-1 p-3 rounded-md border ml-2 items-center ${identity?.is_stealth
