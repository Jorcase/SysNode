...
def stream_file_bytes(
    ...
    #Lee un archivo local en fragmentos de 4096 bytes(BS) y los transmite secuencialmente por el socket TCP.
...
def receive_file_bytes(
    ...
    received_bytes = 0
    sha256_hash = hashlib.sha256()
    # Asegura que el directorio contenedor exista
    ...
    try:
        ...
        # Verifica si se recibió la cantidad esperada de bytes
